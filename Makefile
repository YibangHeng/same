...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/YibangHeng/clash/constant.Version=$(VERSION)" \
		-X "github.com/YibangHeng/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
